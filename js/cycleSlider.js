  ...
  $.fn.cycle.API = {
    ...
    initSlideshow: function() {
      ...
      if (opts.pauseOnHover) {
        ...
        function() {
          ...
          if (!opts.paused) opts.API.trigger('cycle-paused', [opts]);
        }, function() {
          opts.hoverPaused = false;
          if (!opts.paused) opts.API.trigger('cycle-resumed', [opts]);
        });
      }
    ...
    prepareTx: function(manual, fwd) {
      ...
      if (opts.nextSlide != opts.currSlide && (manual || (!opts.paused && !opts.hoverPaused && opts.timeout))) { // #62
        ...
        if (opts.updateView < 0) opts.API.updateView();
      } else {
        opts.API.queueTransition(slideOpts);
      }
    },
...
/*! Cycle2 autoheight plugin; Copyright (c) M.Alsup, 2012; version: 20121213 */ (function($) {
  "use strict";
  ...
  $(document).on('cycle-destroyed', function(e, opts) {
    ...
    if (opts._autoHeightOnResize) $(window).off('resize', opts._autoHeightOnResize);
  });

})(jQuery);

/*! caption plugin for Cycle2;  version: 20121125 */ (function($) {
  "use strict";
...
/*! command plugin for Cycle2;  version: 20121120 */ (function($) {
  "use strict";
...
/*! hash plugin for Cycle2;  version: 20121120 */ (function($) {
  "use strict";
...
/*! loader plugin for Cycle2;  version: 20121219 */ (function($) {
  "use strict";
...
/*! pager plugin for Cycle2;  version: 20121125 */ (function($) {
  "use strict";
...
/*! prevnext plugin for Cycle2;  version: 20121120 */ (function($) {
  "use strict";
...
/*! progressive loader plugin for Cycle2;  version: 20121120 */ (function($) {
  "use strict";
...
/*! tmpl plugin for Cycle2;  version: 20121125 */ (function($) {
  "use strict";
